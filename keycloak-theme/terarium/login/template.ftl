...
<aside class="terarium-intro">
    <img src="${url.resourcesPath}/img/logo.png">
    <p>
        Welcome to the<br>knowledge-modeling-simulation<br>ecosystem built for researchers.
    </p>
    <p>
    ...
    <p>
        Evaluate and contribute to<br>an accelerating scientific landscape.
    </p>
</aside>
<main>
